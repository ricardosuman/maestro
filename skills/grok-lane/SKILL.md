...
Dispatching `maestro:lane-runner` with `lane: grok`, the spec file, and the project instead of the Bash launch makes the run appear in Claude Code's native agent list with a transcript.
